...
import com.volsu.maplibui.api.IChooseLayerResult;
...
import com.volsu.maplibui.service.TrackerService;
...
import com.volsu.gis.fragment.LayersFragment;
import com.volsu.gis.fragment.MapFragment;
...
import static com.volsu.maplibui.service.TrackerService.hasUnfinishedTracks;
import static com.volsu.maplibui.service.TrackerService.isTrackerServiceRunning;
        ...
        implements GpsEventListener, IChooseLayerResult
{
    ...
    public void showEditToolbar() {
        ...
        MenuItem item = mToolbar.getMenu().findItem(com.volsu.maplibui.R.id.menu_edit_redo);
        boolean visible = mMapFragment.getMode() != MapFragment.MODE_EDIT_BY_WALK;
        item.setVisible(visible);
        item = mToolbar.getMenu().findItem(com.volsu.maplibui.R.id.menu_edit_undo);
        item.setVisible(visible);
        ...
        if (result == null) {
            ...
            try {
                ...
                Bitmap sourceBitmap = BitmapFactory.decodeResource(
                        getResources(), com.volsu.maplibui.R.drawable.bk_tile);
