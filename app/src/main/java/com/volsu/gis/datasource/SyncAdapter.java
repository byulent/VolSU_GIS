...
package com.volsu.gis.datasource;
...
public class SyncAdapter extends com.volsu.maplib.datasource.ngw.SyncAdapter {
        ...
        switch (notificationType) {
            case SYNC_START:
                ...
                builder.setProgress(0, 0, true)
                        .setTicker(context.getString(com.volsu.maplib.R.string.sync_started))
                        .setContentTitle(context.getString(com.volsu.maplib.R.string.synchronization))
                        .setContentText(context.getString(com.volsu.maplib.R.string.sync_progress));
                break;

            case SYNC_FINISH:
                largeIcon = NotificationHelper.getLargeIcon(R.drawable.ic_action_apply_dark, context.getResources());
                builder.setProgress(0, 0, false)
                        .setTicker(context.getString(com.volsu.maplib.R.string.sync_finished))
                        .setContentTitle(context.getString(com.volsu.maplib.R.string.synchronization))
                        .setContentText(context.getString(com.volsu.maplib.R.string.sync_finished));
                break;

            case SYNC_CANCELED:
                largeIcon = NotificationHelper.getLargeIcon(R.drawable.ic_action_cancel_dark, context.getResources());
                builder.setProgress(0, 0, false)
                        .setTicker(context.getString(com.volsu.maplib.R.string.sync_canceled))
                        .setContentTitle(context.getString(com.volsu.maplib.R.string.synchronization))
                        .setContentText(context.getString(com.volsu.maplib.R.string.sync_canceled));
                break;

            case SYNC_CHANGES:
                largeIcon = NotificationHelper.getLargeIcon(R.drawable.ic_action_warning_dark, context.getResources());
                builder.setProgress(0, 0, false)
                        .setTicker(context.getString(com.volsu.maplib.R.string.sync_error))
                        .setContentTitle(context.getString(com.volsu.maplib.R.string.synchronization))
