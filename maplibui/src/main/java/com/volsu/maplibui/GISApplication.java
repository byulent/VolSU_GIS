...
import com.volsu.maplib.util.PermissionUtil;
...
import static com.volsu.maplib.util.SettingsConstants.KEY_PREF_MAP;
import static com.volsu.maplibui.util.SettingsConstantsUI.KEY_PREF_DARK;
import static com.volsu.maplibui.util.SettingsConstantsUI.KEY_PREF_LIGHT;
import static com.volsu.maplibui.util.SettingsConstantsUI.KEY_PREF_NEUTRAL;
import static com.volsu.maplibui.util.SettingsConstantsUI.KEY_PREF_SYNC_PERIOD;
import static com.volsu.maplibui.util.SettingsConstantsUI.KEY_PREF_SYNC_PERIODICALLY;
...
public abstract class GISApplication extends Application
    ...
    public Bitmap getMapBackground() {
        ...
        switch (mSharedPreferences.getString(SettingsConstantsUI.KEY_PREF_MAP_BG, KEY_PREF_NEUTRAL)) {
            case KEY_PREF_LIGHT:
                backgroundResId = com.volsu.maplibui.R.drawable.bk_tile_light;
                break;
            case KEY_PREF_DARK:
                backgroundResId = com.volsu.maplibui.R.drawable.bk_tile_dark;
                break;
            default:
                backgroundResId = com.volsu.maplibui.R.drawable.bk_tile;
                break;
        }
