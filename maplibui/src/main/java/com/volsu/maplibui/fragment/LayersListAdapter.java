...
import com.volsu.maplib.api.MapEventListener;
...
import com.volsu.maplib.map.Layer;
import com.volsu.maplib.map.LayerGroup;
import com.volsu.maplib.map.LocalTMSLayer;
import com.volsu.maplib.map.MapDrawable;
import com.volsu.maplib.map.NGWLookupTable;
import com.volsu.maplib.map.NGWRasterLayer;
import com.volsu.maplib.map.NGWTrackLayer;
import com.volsu.maplib.map.RemoteTMSLayer;
import com.volsu.maplib.map.Table;
...
import com.volsu.maplibui.mapui.MapView;
import com.volsu.maplibui.mapui.NGWRasterLayerUI;
import com.volsu.maplibui.mapui.NGWWebMapLayerUI;
...
import com.volsu.maplibui.util.LayerUtil;
import com.volsu.maplibui.util.NGWTrackLayerCreateTask;
...
//                                                handleTrackSync();
            ...
            int newPosition)
    {
        ...
        mMap.moveLayer(newPositionFixed, (com.volsu.maplib.api.ILayer) getItem(originalPosition));
        notifyDataSetChanged();
    }
