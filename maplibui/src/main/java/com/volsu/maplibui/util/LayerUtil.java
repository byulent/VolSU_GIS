...
package com.volsu.maplibui.util;
...
import com.volsu.maplib.map.TrackLayer;
...
import com.volsu.maplibui.activity.FormBuilderModifyAttributesActivity;
import com.volsu.maplibui.activity.ModifyAttributesActivity;
import com.volsu.maplibui.activity.NGActivity;
import com.volsu.maplibui.api.IVectorLayerUI;
import com.volsu.maplibui.service.LayerFillService;
...
import static com.volsu.maplib.util.GeoConstants.CRS_WEB_MERCATOR;
import static com.volsu.maplib.util.GeoConstants.CRS_WGS84;
...
import static com.volsu.maplib.util.GeoConstants.GEOJSON_ATTACHES;
import static com.volsu.maplib.util.GeoConstants.GEOJSON_CRS;
import static com.volsu.maplib.util.GeoConstants.GEOJSON_CRS_EPSG_3857;
import static com.volsu.maplib.util.GeoConstants.GEOJSON_GEOMETRY;
import static com.volsu.maplib.util.GeoConstants.GEOJSON_NAME;
import static com.volsu.maplib.util.GeoConstants.GEOJSON_PROPERTIES;
import static com.volsu.maplib.util.GeoConstants.GEOJSON_TYPE;
import static com.volsu.maplib.util.GeoConstants.GEOJSON_TYPE_FEATURES;
import static com.volsu.maplib.util.GeoConstants.GEOJSON_TYPE_Feature;
import static com.volsu.maplib.util.GeoConstants.GEOJSON_TYPE_FeatureCollection;
import static com.volsu.maplibui.util.ConstantsUI.KEY_FEATURE_ID;
import static com.volsu.maplibui.util.ConstantsUI.KEY_FORM_PATH;
import static com.volsu.maplibui.util.ConstantsUI.KEY_GEOMETRY;
import static com.volsu.maplibui.util.ConstantsUI.KEY_GEOMETRY_CHANGED;
import static com.volsu.maplibui.util.ConstantsUI.KEY_LAYER_ID;
    ...
    private static class ExportGeoJSONTask extends AsyncTask<Void, Void, File> {
        ...
        protected File doInBackground(Void... voids) {
            try {
                ...
                String fileName = com.volsu.maplib.util.LayerUtil.normalizeLayerName(mLayer.getName()) + ".zip";
